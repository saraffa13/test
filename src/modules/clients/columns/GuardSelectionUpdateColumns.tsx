...
// This factory returns the columns for selected guards, including custom actions for alertness and remove.
export const getSelectedGuardsColumnsWithActions = (
  ...
  handleRemoveGuard: (guardId: string) => void
): GridColDef[] => [
...

  {
    ...
    renderCell: (params) => (
      <Button
        ...
        onClick={(e) => {
          e.stopPropagation();
          handleRemoveGuard(params.row.id);
        }}
        variant="outlined"
      >
        Remove
